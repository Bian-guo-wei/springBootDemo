(function (c) {
    c.Zebra_Dialog = function (g, p) {
        ...
        a.init = function () {
            ...
            a.settings.modal && (a.overlay = jQuery("<div>", {"class": "ZebraDialogOverlay"}).css({
            ...
            a.dialog = jQuery("<div>", {"class": "ZebraDialog" + (a.settings.custom_class ? " " + a.settings.custom_class : "")}).css({
                position: a.isIE6 ? "absolute" : "fixed",
                left: 0,
                top: 0,
                visibility: "hidden"
            ...
            if (a.settings.source && "object" == typeof a.settings.source) {
                ...
                for (e in a.settings.source) switch (e) {
                    case "ajax":
                        var l = "string" == typeof a.settings.source[e] ? {url: a.settings.source[e]} : a.settings.source[e],
                    ...
                    case "iframe":
                        l = c.extend({
                            ...
                            marginwidth: "0",
                            frameborder: "0"
                        }, "string" == typeof a.settings.source[e] ? {src: a.settings.source[e]} : a.settings.source[e]);
        ...
        var n = function (d) {
            var b = c(window).width(), h = c(window).height(), f = a.dialog.width(), e = a.dialog.height(),
                b = {left: 0, top: 0, right: b - f, bottom: h - e, center: (b - f) / 2, middle: (h - e) / 2};
            ...
            "boolean" == typeof d && !1 === d || 0 === a.settings.reposition_speed ? a.dialog.css({
                ...
                visibility: "visible",
                opacity: 0
            }).animate({opacity: 1}, a.settings.animation_speed_show) : (a.dialog.stop(!0), a.dialog.css("visibility", "visible").animate({
                left: a.dialog_left,
                top: a.dialog_top

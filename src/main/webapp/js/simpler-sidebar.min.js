...
!function (a) {
    ...
    a.fn.simplerSidebar = function (b) {
        ...
        return this.each(function () {
            ...
            var b, d, e, f, g, h, i = c.attr, j = a(this), k = a(c.opener), l = a(c.sidebar.closingLinks),
                m = c.animation.duration, n = c.sidebar.width, o = c.sidebar.gap, p = n + o, q = a(window).width(),
                r = {}, s = {}, t = function () {
                    a("body, html").css("overflow", "hidden")
                }, u = function () {
                    a("body, html").css("overflow", "auto")
                }, v = {duration: m, easing: c.animation.easing, complete: t},
                w = {duration: m, easing: c.animation.easing, complete: u}, x = a("<div>").attr("data-" + i, "mask");
            "right" === c.sidebar.align ? b = "right" : "left" === c.sidebar.align && (b = "left"), d = p > q ? q - o : n, e = {
                ...
                c = p > e ? e - o : n, d = {width: c}, d[b] = -c, j.attr("data-" + i, "disabled").css(d), x.fadeOut(m), a("body, html").css({overflow: "auto"})
            })
        })
        ...
        sidebar: {width: 350, gap: 64, closingLinks: "a", css: {zIndex: 3e3}},

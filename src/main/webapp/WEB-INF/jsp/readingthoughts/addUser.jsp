    ...
    <div class="content_wrap">
        ...
        <div class="main_content">
            ...
            <div class="content_top">
                <i class="icon"></i>系统--新增管理员
                <div class="back">返回</div>
            </div>
            <div class="UserAdminbox">
                    <div class="right">
                        <span style="color: red;">*</span>
                        用户名：<input type="text" id="name" class="txt">
                    </div>

                    <div class="right">
                        <span style="color: red;">*</span>
                        密码：<input type="password" id="password" class="txt">
                    </div>
                    <div class="right">
                        <span style="color: red;">*</span>
                        请再次输入密码：<input type="password" id="password2" class="txt">
                    </div>
                    <div class="right">
                        <span style="color: red;">*</span>
                        真实姓名：<input type="text" id="realName" class="txt">
                    </div>

                    <div class="adminButton">
                        <input type="button" value="确定" onclick="publish()">
                    </div>
            </div>
...
<script type="text/javascript">
    ...
    function publish() {
        ...
        if(password2 == password){
            ...
            $.ajax({
                url: '${pageContext.request.contextPath}/backendAdminController/appendUser',
                type: "POST",
                dataType: 'json',
                data: {
                    userInfoStr: userStr
